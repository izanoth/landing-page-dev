  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-purpleStart via-indigoMid to-blueEnd text-white">
      <div className="container mx-auto px-4 z-10">
        ...
        <a href="#projects">
        	<button className="px-8 py-3 cursor-pointer bg-gradient-to-r from-indigo-500 via-indigo-600 to-indigo-400 rounded-full text-lg font-semibold shadow-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fade-in-up delay-400">
          {t('button')}
			</button>        
        </a>
      </div>
      <div className="absolute inset-0 z-0">
        <img src="/img/hero-banner.png" alt="background" className="w-full h-full grayscale-40 object-cover" />
      </div>
    </section>
  );
};
